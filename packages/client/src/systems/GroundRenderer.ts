...
// Rolling hills silhouette at bottom of world
// Extended below WORLD_HEIGHT for fill-scaling
// ============================================
...
export class GroundRenderer {
  constructor(parent: Container) {
    ...
    // Extra height below world boundary for fill-scale cropping safety
    const EXTEND = 300;
    const BOTTOM = WORLD_HEIGHT + EXTEND;

    // Dark hill layer (back)
    const hill1 = new Graphics();
    hill1.moveTo(0, BOTTOM);
    ...
    hill1.lineTo(WORLD_WIDTH, BOTTOM);
    hill1.closePath();
    hill1.fill(0x1a0e08);
